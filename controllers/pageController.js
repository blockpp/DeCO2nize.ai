...
const repGen = async(req, res) => {
    res.render('reportGeneration');
}
module.exports = {homePage, dashboard,mark_co2,report_co2,all_emission,transparent,allowance,buy_token,sell_token,marketplace, KYC, quiz_reward,repGen}
